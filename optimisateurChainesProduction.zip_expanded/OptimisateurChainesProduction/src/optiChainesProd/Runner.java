...
import optiChainesProd.optimisateur.OptimisateurAtelierCorrec;
...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        //Créer l'optimiseur
        final OptimisateurAtelier oa = new OptimisateurAtelierCorrec(); //TODO : instancier l'optimisateur
